      ...
      return core.Utils.block(
        ...
        function () {
          ...
          try {
            ...
            //e.g. 2*x
              ...
              if (symbol.power.equals(1)) {
                ...
                if (p === -1 && x.group !== PL) {
                  ...
                  if (x.group === S && x.power.equals(2)) {
                    if (
                      ax.multiplier.lessThan(0) &&
                      !b.multiplier.lessThan(0)
                    ) {
                      a.negate();
                      //it's asin
                ...
                if (!a.contains(dx, true) && symbol.isLinear()) {
                  ...
                  if (fname === ABS) {
                    ...
                    if (x.group === S && !x.power.lessThan(0)) {
                      if (core.Utils.even(x.power)) {
                        ...
                        integrated.power = integrated.power.subtract(
                          new Frac(1)
                        );
                        retval = _.multiply(
                          _.multiply(
                            _.symfunction(ABS, [x.toLinear()]),
                            integrated
                          ),
                          a
                        );
                    ...
                    if (
                      ...
                      __.integration.stop(); //ASIN, ACOS, ATAN
                    /**TODO**/ switch (fname) {
                      case COS:
                  ...
                  if (fname === COS || fname === SIN) {
                    ...
                    if (p < 0) {
                      ...
                      var t = _.symfunction(fname === COS ? SIN : COS, [
                        arg.clone()
                      ]);
                  ...
                  //sec(x)^n or csc(x)^n
                    ...
                    (fname === COSH || fname === SINH) &&
                    symbol.power.equals(2)
                  ) {
              ...
              if (cfsymbol.group !== CB) {
                ...
                if (l === 2) {
                  ...
                  if (!retval) {
                    ...
                    if (g1 === FN && g2 === FN) {
                      if (fn1 === LOG || fn2 === LOG) {
                        retval = __.integration.by_parts(
                          symbol.clone(),
                          dx,
                          depth,
                          opt
                        ...
                        if (arg1.equals(arg2)) {
                          if (
                            ...
                            if (
                              fn1 === SIN &&
                              sym1.power.add(sym2.power).equals(0)
                            ) {
                              sym1.fname = TAN;
                              sym1.updateHash();
                      ...
                      if (sym2.value === sym1.value && sym1.power.equals(-1)) {
                        ...
                        var pd = Math.min.apply(
                          null,
                          core.Utils.keys(sym1.symbols)
                        );
                      ...
                      if (sym1.power.equals(-1 / 2)) {
                        ...
                        if (
                          ...
                          retval = _.multiply(
                            c,
                            integral.sub(new Symbol("u"), bksub)
                          );
                        }
                        ...
                        sym1.power.lessThan(0) &&
                        sym2.power.greaterThan(1)
                      ) {
                        var decomp = __.integration.decompose_arg(
                            sym1.clone().toLinear(),
                            dx
                        ...
                        if (x.group !== PL && x.isLinear()) {
                          ...
                          sym1 = core.Algebra.Factor.coeffFactor(
                            sym1.invert(),
                            factors
                          );
                          retval = new Symbol(0);
                      ...
                      retval = new Symbol(0);
                      if (
                        sym1.power.greaterThan(0) &&
                        sym2.power.greaterThan(0)
                      ) {
                      ...
                      g1 === FN &&
                      g2 === EX &&
                      core.Utils.in_htrig(sym1.fname)
                    ) {
                      sym1 = sym1.fnTransform();
                      retval = __.integrate(
                        _.expand(_.multiply(sym1, sym2)),
                        dx,
                        depth
                      );
                    } else {
            ...
            if (
              !(
                error instanceof NoIntegralFound ||
                error instanceof core.exceptions.DivisionByZero
              )
            )
              throw error;
          }
